...
//      02h -         nnnnnnnn  number of rows    (vertical displayed number of characters)
//      04h -       n nnnnnnnn  window left       (horizontal sync position - reference for left edge of displayed)
//      06h -       n nnnnnnnn  window top        (vertical sync position - reference for the top edge of displayed)
//      08h -         ---nnnnn  maximum scan line (char ROM max value is 7)
//		0Ah -         hhhhwwww  pixel size, hhhh=height,wwww=width
//      0Eh -       n nnnnnnnn  color code for transparent background
//      10h -         -BPnnnnn  cursor start / blink control
//                             BP: 00=no blink
//                             BP: 01=no display
//                             BP: 10=1/16 field rate blink
//                             BP: 11=1/32 field rate blink
//      12h -        ----nnnnn  cursor end
//      14h - aaaaaaaa aaaaaaaaa  start address (index into display memory)
//      16h - aaaaaaaa aaaaaaaaa  cursor position
//      18h - aaaaaaaa aaaaaaaaa  light pen position
//--------------------------------------------------------------------
//
// ============================================================================

module DSD7_TextController(
	rst_i, clk_i,
