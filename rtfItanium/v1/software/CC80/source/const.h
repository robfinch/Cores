...
enum e_op {
	...
	op_std, op_stp, op_stw, op_stb, op_outb, op_inb, op_inbu,
	op_sfd, op_lfd,
	...
	op_lft, op_sft,
	op_ldd, op_ldp, op_ldw, op_ldb, op_ret, op_sm, op_lm, op_ldis, op_ldds, op_stds,
	op_lvb, op_lvc, op_lvh, op_lvw,
	op_inc, op_dec,
	op_ldbu, op_ldwu, op_ldpu, op_sti,
	op_lf, op_sf,
	op_rts, op_rtd,
