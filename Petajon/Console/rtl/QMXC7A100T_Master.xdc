...
set_property PACKAGE_PIN M26 [get_ports {FAD[27]}]
set_property PACKAGE_PIN L23 [get_ports {FAD[28]}]
set_property PACKAGE_PIN P26 [get_ports {FAD[29]}]
set_property PACKAGE_PIN M25 [get_ports {FAD[30]}]
set_property PACKAGE_PIN N22 [get_ports {FAD[31]}]

set_property PACKAGE_PIN R26 [get_ports {FSEL[0]}]
...
set_property PACKAGE_PIN P25 [get_ports {FRDYN}]
...
set_property PACKAGE_PIN L22 [get_ports {FCDIR}]
...
set_property PACKAGE_PIN T3 [get_ports {FMRQ[2]}]
...
set_property PACKAGE_PIN T24 [get_ports {MS[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {MS[0]}]
set_property PACKAGE_PIN R25 [get_ports {MS[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {MS[1]}]
set_property PACKAGE_PIN T25 [get_ports {MS[2]}]
...
# Transmit
set_property -dict {PACKAGE_PIN P1 IOSTANDARD TMDS_33} [get_ports FTCLK0N]
set_property -dict {PACKAGE_PIN R1 IOSTANDARD TMDS_33} [get_ports FTCLK0P]
set_property -dict {PACKAGE_PIN U1 IOSTANDARD TMDS_33} [get_ports {FTDAT0N}]
set_property -dict {PACKAGE_PIN U2 IOSTANDARD TMDS_33} [get_ports {FTDAT0P}]
set_property -dict {PACKAGE_PIN R2 IOSTANDARD TMDS_33} [get_ports {FTDAT1N}]
set_property -dict {PACKAGE_PIN T2 IOSTANDARD TMDS_33} [get_ports {FTDAT1P}]
set_property -dict {PACKAGE_PIN T3 IOSTANDARD TMDS_33} [get_ports {FTDAT2N}]
set_property -dict {PACKAGE_PIN T4 IOSTANDARD TMDS_33} [get_ports {FTDAT2P}]
 
# Receive
set_property -dict {PACKAGE_PIN AC24 IOSTANDARD TMDS_33} [get_ports FRCLK0N]
set_property -dict {PACKAGE_PIN AB24 IOSTANDARD TMDS_33} [get_ports FRCLK0P]
set_property -dict {PACKAGE_PIN Y23 IOSTANDARD TMDS_33} [get_ports {FRDAT0N}]
set_property -dict {PACKAGE_PIN Y22 IOSTANDARD TMDS_33} [get_ports {FRDAT0P}]
set_property -dict {PACKAGE_PIN W23 IOSTANDARD TMDS_33} [get_ports {FRDAT1N}]
set_property -dict {PACKAGE_PIN V23 IOSTANDARD TMDS_33} [get_ports {FRDAT1P}]
set_property -dict {PACKAGE_PIN V21 IOSTANDARD TMDS_33} [get_ports {FRDAT2N}]
set_property -dict {PACKAGE_PIN U21 IOSTANDARD TMDS_33} [get_ports {FRDAT2P}]
