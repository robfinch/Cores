...
parameter REG_SYNC_ONOFF = 9'd18;
parameter REG_BLANK_ONOFF = 9'd20;
parameter REG_BORDER_ONOFF = 9'd22;
parameter REG_RASTCMP = 9'd24;
parameter REG_BMPSIZE = 9'd26;
parameter REG_OOB_COLOR = 9'd28;
parameter REG_WINDOW = 9'd30;
...
(
  ...
  .addra({2'b0,adri[9:2]}),  // input wire [8 : 0] addra
...
`endif
  ...
  REG_PXYZ:		    s_dat_o <= {py,px};
  REG_PXYZ+1:	    s_dat_o <= pz;
  REG_PCOLCMD:    s_dat_o <= {raster_op,14'd0,pcmd};
  REG_PCOLCMD+1:  s_dat_o <= color_o;
  REG_OOB_COLOR:	s_dat_o <= oob_color;
  REG_WINDOW:			s_dat_o <= {4'h0,windowHeight,4'h0,windowWidth};
  REG_WINDOW+1:		s_dat_o <= {windowTop,windowLeft};
  9'b10??_????_??:	s_dat_o <= pal_wo;
