...
#set_false_path -from [get_clocks clk_pll_i] -to [get_clocks ucg1/clk40]
#set_false_path -from [get_clocks ucg1/clk40] -to [get_clocks clk_pll_i]
...
set_property -dict { PACKAGE_PIN W5    IOSTANDARD LVCMOS33 } [get_ports { eeprom_clk }]; #IO_L15N_T2_DQS_34 Sch=scl
set_property -dict { PACKAGE_PIN V5    IOSTANDARD LVCMOS33 } [get_ports { eeprom_data }]; #IO_L16N_T2_34 Sch=sda
set_property PULLUP true [get_ports {eeprom_clk}]
set_property PULLUP true [get_ports {eeprom_data}]
