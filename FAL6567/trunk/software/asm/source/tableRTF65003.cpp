...
static Opa sxbAsm[] = { {AsmRTF65002::sxb, 0x00D7, 0, 0, 2}, NULL };
static Opa sxcAsm[] = { {AsmRTF65002::sxb, 0x10D7, 0, 0, 2}, NULL };
static Opa zxbAsm[] = { {AsmRTF65002::sxb, 0x20D7, 0, 0, 2}, NULL };
static Opa zxcAsm[] = { {AsmRTF65002::sxb, 0x30D7, 0, 0, 2}, NULL };

static Opa nopAsm[] = { {Asm6502::out8, 0xEA, 0, 0 ,2}, NULL };

static Opa cmpAsm[] =
{
	{AsmRTF65002::cmp_rr, 0x86, 2, (AM_RN<<8)|AM_RN, 2},
//	{AsmRTF65002::rnbit, 0x1002, 2, (AM_RN<<8)|AM_RN, 2},
	...
	{AsmRTF65002::Ximm32, 0xC9, 1, AM_IMM32, 2},
...
static Opa cpxAsm[] =
{
	{AsmRTF65002::Ximm8, 0xE2, 1, AM_IMM4, 2},
	{AsmRTF65002::Ximm8, 0xE2, 1, AM_IMM8, 2},
...
static Opa cpyAsm[] =
{
	{AsmRTF65002::Ximm8, 0xC1, 1, AM_IMM4, 2},
	{AsmRTF65002::Ximm8, 0xC1, 1, AM_IMM8, 2},
...
static Opa stAsm[] =
{
	{AsmRTF65002::zpbit, 0x84, 2, (AM_RN<<8)|AM_Z,4},
	{AsmRTF65002::zpbit, 0x84, 2, (AM_RN<<8)|AM_ZX,4},
	{AsmRTF65002::zpbit, 0x84, 2, (AM_RN<<8)|AM_ZY,4},
	...
	{AsmRTF65002::bit_absx, 0x9E, 2, (AM_RN<<8)|AM_AX,4},
	{AsmRTF65002::bit_absx, 0x9E, 2, (AM_RN<<8)|AM_AY,4},
...
static Opa staAsm[] =
{
	{AsmRTF65002::zpsta, 0x84, 1, AM_Z,4},
    {AsmRTF65002::zp2, 0x95, 1, AM_ZX,4},
	{AsmRTF65002::zp2, 0x95, 1, AM_ZY,4},
	...
	{AsmRTF65002::ldx_absx, 0x9D, 1, AM_AX,4},
	{AsmRTF65002::ldx_absx, 0x9D, 1, AM_AY,4},
	{AsmRTF65002::st_acc_dsp, 0x83, 1, AM_SR,4},
	NULL
};
...
static Opa stxAsm[] =
{
	...
	{AsmRTF65002::stx_absx, 0x9E, 1, AM_AX,4},
	{AsmRTF65002::stx_absx, 0x9E, 1, AM_AY,4},
...
static Opa styAsm[] =
{
	...
	{AsmRTF65002::sty_absx, 0x9E, 1, AM_AX,4},
	{AsmRTF65002::sty_absx, 0x9E, 1, AM_AY,4},
...
static Opa stzAsm[] =
{
    {AsmRTF65002::stz_zp, 0x84, 1, AM_Z,4},
    {AsmRTF65002::stz_zp, 0x84, 1, AM_ZX,4},
    {AsmRTF65002::stz_zp, 0x84, 1, AM_ZY,4},
	{AsmRTF65002::stz_abs, 0x9C, 1, AM_A,4},
	{AsmRTF65002::stz_rind, 0x92, 1, AM_RIND,4},
	{AsmRTF65002::stz_absx, 0x9E, 1, AM_AX,4},
	{AsmRTF65002::stz_absx, 0x9E, 1, AM_AY,4},
	NULL
};
...
static Opa ldAsm[] =
{
	...
	{AsmRTF65002::zpld, 0x01, 2, (AM_RN<<8)|AM_ZI,5},
...
static Opa leaAsm[] =
{
	{AsmRTF65002::zpld, 0xD542, 2, (AM_RN<<8)|AM_Z,2},
	{AsmRTF65002::zpld, 0xD542, 2, (AM_RN<<8)|AM_ZY,2},	// force abs,y
    {AsmRTF65002::zpld, 0xD542, 2,(AM_RN<<8)| AM_ZX,2},
    {AsmRTF65002::zpld, 0xC142, 2, (AM_RN<<8)|AM_IX,5},
    {AsmRTF65002::zpld, 0xD142, 2, (AM_RN<<8)|AM_IY,6},
	{AsmRTF65002::zpld, 0xC142, 2, (AM_RN<<8)|AM_ZI,5},
	{AsmRTF65002::absld, 0xCD42, 2, (AM_RN<<8)|AM_A,2},
	{AsmRTF65002::absxld, 0xDD42, 2, (AM_RN<<8)|AM_AX,2},
	{AsmRTF65002::absxld, 0xDD42, 2, (AM_RN<<8)|AM_AY,2},
	{AsmRTF65002::rindld, 0xD242, 2, (AM_RN<<8)|AM_RIND,2},
	{AsmRTF65002::ld_dsp, 0xC342, 2, (AM_RN<<8)|AM_SR,2},
	{AsmRTF65002::ld_acc_dsp, 0xC342, 1, AM_SR,2},
	NULL
};
...
static Opa ldaAsm[] =
{
	...
	{AsmRTF65002::zp2, 0xB5, 1, AM_Z,4},
	{AsmRTF65002::zp2, 0xB5, 1, AM_ZY,4},	// force abs,y
    {AsmRTF65002::zp2, 0xB5, 1, AM_ZX,4},
    {AsmRTF65002::zplda, 0x01, 1, AM_IX,5},
    {AsmRTF65002::zplda, 0x11, 1, AM_IY,6},
	{AsmRTF65002::zplda, 0x01, 1, AM_ZI,5},
	{AsmRTF65002::ldx_abs, 0xAD, 1, AM_A,4},
	{AsmRTF65002::ldx_absx, 0xBD, 1, AM_AX,4},
	{AsmRTF65002::ldx_absx, 0xBD, 1, AM_AY,4},
...
//	{AsmRTF65002::rny, 0x5002, 1 AM_RN},
	{AsmRTF65002::Ximm8, 0xA1, 1, AM_IMM4,2},
	{AsmRTF65002::Ximm8, 0xA1, 1, AM_IMM8,2},
...
static Mne opsRTF65003[] =
{
	...
	Operands65002 operRTF65003;

	Cpu optabRTF65003 =
	{
		"RTF65003", 32, 1, 42, sizeof(opsRTF65003)/sizeof(Mne), opsRTF65003, (Operands *)&operRTF65003
	};
}
