...
always @(posedge vclk)
if (rst)
  stCycler <= 33'b100000000000000000000000000000000;
else
  stCycler <= {stCycler[31:0],stCycler[32]};
assign stCycle = stCycler[32];
...
//------------------------------------------------------------------------------
always @(my,nextRasterY,rasterY,MActive,cycle,me)
case(chip)
CHIP6567R8:
  begin
  balo0 = ((my[0]==nextRasterY)||MActive[0]) && cycle>=8'd57 && cycle < 8'd61 && me[0];
  balo1 = ((my[1]==nextRasterY)||MActive[1]) && cycle>=8'd58 && cycle < 8'd62 && me[1];
  balo2 = ((my[2]==nextRasterY)||MActive[2]) && cycle>=8'd59 && cycle < 8'd63 && me[2];
  balo3 = ((my[3]==nextRasterY)||MActive[3]) && cycle>=8'd60 && cycle < 8'd64 && me[3];
  balo4 = ((my[4]==nextRasterY)||MActive[4]) && cycle>=8'd61 && cycle < 8'd65 && me[4];
  balo5 = ((my[5]==nextRasterY)||MActive[5]) && (cycle>=8'd62 || cycle < 8'd01) && me[5];
  balo6 = ((my[6]==nextRasterY)||MActive[6]) && (cycle>=8'd63 || cycle < 8'd02) && me[6];
  balo7 = ((my[7]==nextRasterY)||MActive[7]) && (cycle>=8'd64 || cycle < 8'd03) && me[7];
  balo8 = ((my[8]==nextRasterY)||MActive[8]) && (cycle>=8'd65 || cycle < 8'd04) && me[8];
  balo9 = ((my[9]==rasterY)||MActive[9]) && (cycle>=8'd1 || cycle < 8'd05) && me[9];
  balo10 = ((my[10]==rasterY)||MActive[10]) && (cycle>=8'd2 || cycle < 8'd06) && me[10];
  balo11 = ((my[11]==rasterY)||MActive[11]) && (cycle>=8'd3 || cycle < 8'd07) && me[11];
  balo12 = ((my[12]==rasterY)||MActive[12]) && (cycle>=8'd4 || cycle < 8'd08) && me[12];
  balo13 = ((my[13]==rasterY)||MActive[13]) && (cycle>=8'd5 || cycle < 8'd09) && me[13];
  balo14 = ((my[14]==rasterY)||MActive[14]) && (cycle>=8'd6 || cycle < 8'd10) && me[14];
  balo15 = ((my[15]==rasterY)||MActive[15]) && (cycle>=8'd7 || cycle < 8'd11) && me[15];
  end
CHIP6567OLD:
  begin
  balo0 = ((my[0]==nextRasterY)||MActive[0]) && cycle>=8'd56 && cycle < 8'd60 && me[0];
  balo1 = ((my[1]==nextRasterY)||MActive[1]) && cycle>=8'd57 && cycle < 8'd61 && me[1];
  balo2 = ((my[2]==nextRasterY)||MActive[2]) && cycle>=8'd58 && cycle < 8'd62 && me[2];
  balo3 = ((my[3]==nextRasterY)||MActive[3]) && cycle>=8'd59 && cycle < 8'd63 && me[3];
  balo4 = ((my[4]==nextRasterY)||MActive[4]) && cycle>=8'd60 && cycle < 8'd64 && me[4];
  balo5 = ((my[5]==nextRasterY)||MActive[5]) && (cycle>=8'd61 || cycle < 8'd01) && me[5];
  balo6 = ((my[6]==nextRasterY)||MActive[6]) && (cycle>=8'd62 || cycle < 8'd02) && me[6];
  balo7 = ((my[7]==nextRasterY)||MActive[7]) && (cycle>=8'd63 || cycle < 8'd03) && me[7];
  balo8 = ((my[8]==nextRasterY)||MActive[8]) && (cycle>=8'd64 || cycle < 8'd04) && me[8];
  balo9 = ((my[9]==rasterY)||MActive[9]) && (cycle>=8'd1 || cycle < 8'd05) && me[9];
  balo10 = ((my[10]==rasterY)||MActive[10]) && (cycle>=8'd2 || cycle < 8'd06) && me[10];
  balo11 = ((my[11]==rasterY)||MActive[11]) && (cycle>=8'd3 || cycle < 8'd07) && me[11];
  balo12 = ((my[12]==rasterY)||MActive[12]) && (cycle>=8'd4 || cycle < 8'd08) && me[12];
...
CHIP6569:
  begin
  balo0 = ((my[0]==nextRasterY)||MActive[0]) && cycle>=8'd55 && cycle < 8'd59 && me[0];
  balo1 = ((my[1]==nextRasterY)||MActive[1]) && cycle>=8'd56 && cycle < 8'd60 && me[1];
  balo2 = ((my[2]==nextRasterY)||MActive[2]) && cycle>=8'd57 && cycle < 8'd61 && me[2];
  balo3 = ((my[3]==nextRasterY)||MActive[3]) && cycle>=8'd58 && cycle < 8'd62 && me[3];
  balo4 = ((my[4]==nextRasterY)||MActive[4]) && cycle>=8'd59 && cycle < 8'd63 && me[4];
  balo5 = ((my[5]==nextRasterY)||MActive[5]) && (cycle>=8'd60 || cycle < 8'd01) && me[5];
  balo6 = ((my[6]==nextRasterY)||MActive[6]) && (cycle>=8'd61 || cycle < 8'd02) && me[6];
  balo7 = ((my[7]==nextRasterY)||MActive[7]) && (cycle>=8'd62 || cycle < 8'd03) && me[7];
  balo8 = ((my[8]==nextRasterY)||MActive[8]) && (cycle>=8'd63 || cycle < 8'd04) && me[8];
  balo9 = ((my[9]==rasterY)||MActive[9]) && (cycle>=8'd1 || cycle < 8'd05) && me[9];
  balo10 = ((my[10]==rasterY)||MActive[10]) && (cycle>=8'd2 || cycle < 8'd06) && me[10];
  balo11 = ((my[11]==rasterY)||MActive[11]) && (cycle>=8'd3 || cycle < 8'd07) && me[11];
  balo12 = ((my[12]==rasterY)||MActive[12]) && (cycle>=8'd4 || cycle < 8'd08) && me[12];
...
assign balo = balo0|balo1|balo2|balo3|balo4|balo5|balo6|balo7|
              balo8|balo9|balo10|balo11|balo12|balo13|balo14|balo15|
              baloc; 
...
// When to reset the sprite data counter

always @(chip,my,nextRasterY,rasterY,cycle,me)
case(chip)
CHIP6567R8:
  begin
  sprst[0] = (my[0]==nextRasterY) && cycle == 8'd58 && me[0];
  sprst[1] = (my[1]==nextRasterY) && cycle == 8'd59 && me[1];
  sprst[2] = (my[2]==nextRasterY) && cycle == 8'd60 && me[2];
  sprst[3] = (my[3]==nextRasterY) && cycle == 8'd61 && me[3];
  sprst[4] = (my[4]==nextRasterY) && cycle == 8'd62 && me[4];
  sprst[5] = (my[5]==nextRasterY) && cycle == 8'd63 && me[5];
  sprst[6] = (my[6]==nextRasterY) && cycle == 8'd64 && me[6];
  sprst[7] = (my[7]==nextRasterY) && cycle == 8'd65 && me[7];
  sprst[8] = (my[8]==rasterY) && cycle == 8'd01 && me[8];
  sprst[9] = (my[9]==rasterY) && cycle == 8'd02 && me[9];
  sprst[10] = (my[10]==rasterY) && cycle == 8'd03 && me[10];
  sprst[11] = (my[11]==rasterY) && cycle == 8'd04 && me[11];
  sprst[12] = (my[12]==rasterY) && cycle == 8'd05 && me[12];
  sprst[13] = (my[13]==rasterY) && cycle == 8'd06 && me[13];
  sprst[14] = (my[14]==rasterY) && cycle == 8'd07 && me[14];
  sprst[15] = (my[15]==rasterY) && cycle == 8'd08 && me[15];
  end
endcase

// Bus cycle during which sprite data is fetched

always @(chip,my,nextRasterY,rasterY,MActive,cycle,me)
case(chip)
CHIP6567R8:
  begin
  sp[0] = ((my[0]==nextRasterY)||MActive[0]) && cycle == 8'd60 && me[0];
  sp[1] = ((my[1]==nextRasterY)||MActive[1]) && cycle == 8'd61 && me[1];
  sp[2] = ((my[2]==nextRasterY)||MActive[2]) && cycle == 8'd62 && me[2];
  sp[3] = ((my[3]==nextRasterY)||MActive[3]) && cycle == 8'd63 && me[3];
  sp[4] = ((my[4]==nextRasterY)||MActive[4]) && cycle == 8'd64 && me[4];
  sp[5] = ((my[5]==nextRasterY)||MActive[5]) && cycle == 8'd65 && me[5];
  sp[6] = ((my[6]==rasterY)||MActive[6]) && cycle == 8'd01 && me[6];
  sp[7] = ((my[7]==rasterY)||MActive[7]) && cycle == 8'd02 && me[7];
  sp[8] = ((my[8]==rasterY)||MActive[8]) && cycle == 8'd03 && me[8];
  sp[9] = ((my[9]==rasterY)||MActive[9]) && cycle == 8'd04 && me[9];
  sp[10] = ((my[10]==rasterY)||MActive[10]) && cycle == 8'd05 && me[10];
  sp[11] = ((my[11]==rasterY)||MActive[11]) && cycle == 8'd06 && me[11];
  sp[12] = ((my[12]==rasterY)||MActive[12]) && cycle == 8'd07 && me[12];
  sp[13] = ((my[13]==rasterY)||MActive[13]) && cycle == 8'd08 && me[13];
  sp[14] = ((my[14]==rasterY)||MActive[14]) && cycle == 8'd09 && me[14];
  sp[15] = ((my[15]==rasterY)||MActive[15]) && cycle == 8'd10 && me[15];
  end
CHIP6567OLD:
  begin
  sp[0] = ((my[0]==nextRasterY)||MActive[0]) && cycle == 8'd59 && me[0];
  sp[1] = ((my[1]==nextRasterY)||MActive[1]) && cycle == 8'd60 && me[1];
  sp[2] = ((my[2]==nextRasterY)||MActive[2]) && cycle == 8'd61 && me[2];
  sp[3] = ((my[3]==nextRasterY)||MActive[3]) && cycle == 8'd62 && me[3];
  sp[4] = ((my[4]==nextRasterY)||MActive[4]) && cycle == 8'd63 && me[4];
  sp[5] = ((my[5]==nextRasterY)||MActive[5]) && cycle == 8'd64 && me[5];
  sp[6] = ((my[6]==rasterY)||MActive[6]) && cycle == 8'd01 && me[6];
  sp[7] = ((my[7]==rasterY)||MActive[7]) && cycle == 8'd02 && me[7];
  sp[8] = ((my[8]==rasterY)||MActive[8]) && cycle == 8'd03 && me[8];
  sp[9] = ((my[9]==rasterY)||MActive[9]) && cycle == 8'd04 && me[9];
