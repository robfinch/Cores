...
// timing. The dot clock is faster though at 33.750MHz. This allows a 640x400
// display area with a border to be created. This is double the horizontal and
// vertical resolution of the VIC-II. 
//
module FAL6567f(cr_clk, phi02, rst_o, irq, aec, ba, cs_n, rw, ad, db, den_n, dir, ras_n, cas_n, lp_n, hSync, vSync, red, green, blue,
...
// Constants multiplied by 1.35 for 33.750MHz clock
parameter phSyncOn  = 22;       //   16 front porch
parameter phSyncOff = 152;		//   96 sync
parameter phBlankOff = 217;		//   48 back porch
parameter phBorderOff = 328;	//    0 border
parameter phBorderOn = 968;	    //  640 display
parameter phBlankOn = 1080;		//    0 border
parameter phTotal = 1080; 		//  800 total clocks
