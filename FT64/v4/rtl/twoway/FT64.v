...
assign rfoc0 = Rc0[12:7]==6'h3F ? vm[Rc0[2:0]] : rfoc0a;
assign rfoc1 = Rc1[12:7]==6'h3F ? vm[Rc1[2:0]] : rfoc1a;
	...
	case(isn[`INSTRUCTION_S2])
        ...
        `VMxx:
        	...
        	`VMAND,`VMOR,`VMXOR,`VMXNOR,`VMPOP,`VMFIRST,`VMLAST:
                    fnRa = {6'h3F,1'b1,3'b0,isn[8:6]};
            `VMFILL:fnRa = {6'd0,1'b1,isn[`INSTRUCTION_RA]};
            default:fnRa = {6'h3F,1'b1,3'b0,isn[8:6]};
            endcase
        `VSHLV:     fnRa = (vqei+1+isn[17:12] >= vli) ? 12'h000 : {vli-vqei-isn[17:12]-1,1'b1,isn[`INSTRUCTION_RA]};
        `VSHRV:     fnRa = (vqei+isn[17:12] >= vli) ? 12'h000 : {vqei+isn[17:12],1'b1,isn[`INSTRUCTION_RA]};
...
`RR:    case(isn[`INSTRUCTION_S2])
		`MOV:
			...
			3'd1:	fnRa = {isn[23:18],1'b0,isn[`INSTRUCTION_RA]};
        ...
        default:    fnRa = {rgs[thrd],1'b0,isn[`INSTRUCTION_RA]};
        endcase
`FLOAT:		fnRa = {rgs[thrd],1'b0,isn[`INSTRUCTION_RA]};
default:    fnRa = {rgs[thrd],1'b0,isn[`INSTRUCTION_RA]};
endcase
endfunction
...
`VECTOR:
			...
			`VMxx:
            	...
            	`VMAND,`VMOR,`VMXOR,`VMXNOR,`VMPOP:
                	fnRb = {6'h3F,1'b1,3'b0,isn[13:11]};
            ...
            endcase
`FLOAT:		fnRb = {rgs[thrd],1'b0,isn[`INSTRUCTION_RB]};
default:    fnRb = {rgs[thrd],1'b0,isn[`INSTRUCTION_RB]};
endcase
endfunction
...
`VECTOR:
			case(isn[`INSTRUCTION_S2])
            `VSxx,`VSxxS,`VSxxU,`VSxxSU:    fnRc = {6'h3F,1'b1,3'b0,isn[18:16]};
            default:    fnRc = {vqei,1'b1,isn[`INSTRUCTION_RC]};
            endcase
`FLOAT:		fnRc = {rgs[thrd],1'b0,isn[`INSTRUCTION_RC]};
...
`VECTOR:
		...
		`VMxx:
        	...
        	`VMAND,`VMOR,`VMXOR,`VMXNOR,`VMFILL:
                    fnRt = {6'h3F,1'b1,3'b0,isn[18:16]};
            `VMPOP:	fnRt = {rgs[thrd],1'b0,isn[`INSTRUCTION_RB]};
            default:
                    fnRt = {6'h3F,1'b1,3'b0,isn[18:16]};
            endcase
        `VSxx,`VSxxU,`VSxxS,`VSxxSU:    fnRt = {6'h3F,1'b1,3'b0,isn[18:16]};
        `VSHLV:     fnRt = (vqei+1 >= vli) ? 12'h000 : {vli-vqei-1,1'b1,isn[`INSTRUCTION_RC]};
        `VSHRV:     fnRt = (vqei >= vli) ? 12'h000 : {vqei,1'b1,isn[`INSTRUCTION_RC]};
...
`RR:    case(isn[`INSTRUCTION_S2])
		`MOV:
			case(isn[33:31])
			3'd0:	fnRt = {isn[23:18],1'b0,isn[`INSTRUCTION_RB]};
...
`AMO:	fnRt = isn[39] ? {rgs[thrd],1'b0,isn[`INSTRUCTION_RB]} : {rgs[thrd],1'b0,isn[`INSTRUCTION_RC]};
default:    fnRt = {rgs[thrd],1'b0,isn[`INSTRUCTION_RB]};
endcase
endfunction
`else
...
`RR:    case(isn[`INSTRUCTION_S2])
        ...
        default:    fnRa = {rgs,1'b0,isn[`INSTRUCTION_RA]};
        endcase
`FLOAT:		fnRa = {rgs,1'b0,isn[`INSTRUCTION_RA]};
default:    fnRa = {rgs,1'b0,isn[`INSTRUCTION_RA]};
endcase
endfunction
...
`VECTOR:
            ...
            default:    fnRb = {vqei,1'b1,isn[`INSTRUCTION_RB]};
            endcase
`FLOAT:		fnRb = {rgs,1'b0,isn[`INSTRUCTION_RB]};
default:    fnRb = {rgs,1'b0,isn[`INSTRUCTION_RB]};
endcase
endfunction
...
`VECTOR:
            ...
            default:    fnRc = {vqei,1'b1,isn[`INSTRUCTION_RC]};
            endcase
`FLOAT:		fnRc = {rgs,1'b0,isn[`INSTRUCTION_RC]};
...
`LV:    fnRt = {vqei,1'b1,isn[`INSTRUCTION_RB]};
`AMO:	fnRt = isn[39] ? {rgs,1'b0,isn[`INSTRUCTION_RB]} : {rgs,1'b0,isn[`INSTRUCTION_RC]};
default:    fnRt = {rgs,1'b0,isn[`INSTRUCTION_RB]};
endcase
endfunction
`endif
...
`Bcc:   Source1Valid = isn[`INSTRUCTION_RA]==6'd0;
`BccR:  Source1Valid = isn[`INSTRUCTION_RA]==6'd0;
`BBc:   Source1Valid = isn[`INSTRUCTION_RA]==6'd0;
`BEQI:  Source1Valid = isn[`INSTRUCTION_RA]==6'd0;
`BCHK:  Source1Valid = isn[`INSTRUCTION_RA]==6'd0;
`CHK:   Source1Valid = isn[`INSTRUCTION_RA]==6'd0;
`R2:    case(isn[`INSTRUCTION_S2])
        `SHIFT:    Source1Valid = isn[`INSTRUCTION_RA]==6'd0;
        `SHIFTH:   Source1Valid = isn[`INSTRUCTION_RA]==6'd0;
        `SHIFTC:   Source1Valid = isn[`INSTRUCTION_RA]==6'd0;
        `SHIFTB:   Source1Valid = isn[`INSTRUCTION_RA]==6'd0;
        default:   Source1Valid = isn[`INSTRUCTION_RA]==6'd0;
        endcase
`ADDI:  Source1Valid = isn[`INSTRUCTION_RA]==6'd0;
`CMPI:  Source1Valid = isn[`INSTRUCTION_RA]==6'd0;
`CMPUI: Source1Valid = isn[`INSTRUCTION_RA]==6'd0;
`ANDI:  Source1Valid = isn[`INSTRUCTION_RA]==6'd0;
`ORI:   Source1Valid = isn[`INSTRUCTION_RA]==6'd0;
`XORI:  Source1Valid = isn[`INSTRUCTION_RA]==6'd0;
`MULUI: Source1Valid = isn[`INSTRUCTION_RA]==6'd0;
`AMO: 	Source1Valid = isn[`INSTRUCTION_RA]==6'd0;
`LB:    Source1Valid = isn[`INSTRUCTION_RA]==6'd0;
`LBO:   Source1Valid = isn[`INSTRUCTION_RA]==6'd0;
`LBU:   Source1Valid = isn[`INSTRUCTION_RA]==6'd0;
`LC:    Source1Valid = isn[`INSTRUCTION_RA]==6'd0;
`LCO:   Source1Valid = isn[`INSTRUCTION_RA]==6'd0;
`LCU:   Source1Valid = isn[`INSTRUCTION_RA]==6'd0;
`LH:    Source1Valid = isn[`INSTRUCTION_RA]==6'd0;
`LHO:   Source1Valid = isn[`INSTRUCTION_RA]==6'd0;
`LHU:   Source1Valid = isn[`INSTRUCTION_RA]==6'd0;
`LW:    Source1Valid = isn[`INSTRUCTION_RA]==6'd0;
`LWR:   Source1Valid = isn[`INSTRUCTION_RA]==6'd0;
`LV:    Source1Valid = isn[`INSTRUCTION_RA]==6'd0;
`LVx:   Source1Valid = isn[`INSTRUCTION_RA]==6'd0;
`SB:    Source1Valid = isn[`INSTRUCTION_RA]==6'd0;
`SC:    Source1Valid = isn[`INSTRUCTION_RA]==6'd0;
`SH:    Source1Valid = isn[`INSTRUCTION_RA]==6'd0;
`SW:    Source1Valid = isn[`INSTRUCTION_RA]==6'd0;
`SWC:   Source1Valid = isn[`INSTRUCTION_RA]==6'd0;
`SV:    Source1Valid = isn[`INSTRUCTION_RA]==6'd0;
`CAS:   Source1Valid = isn[`INSTRUCTION_RA]==6'd0;
`JAL:   Source1Valid = isn[`INSTRUCTION_RA]==6'd0;
`RET:   Source1Valid = isn[`INSTRUCTION_RA]==6'd0;
`CSRRW: Source1Valid = isn[`INSTRUCTION_RA]==6'd0;
...
`Bcc:   Source2Valid = isn[`INSTRUCTION_RB]==6'd0;
`BccR:  Source2Valid = isn[`INSTRUCTION_RB]==6'd0;
`BBc:   Source2Valid = TRUE;
`BEQI:  Source2Valid = TRUE;
`BCHK:  Source2Valid = isn[`INSTRUCTION_RB]==6'd0;
`CHK:   Source2Valid = isn[`INSTRUCTION_RB]==6'd0;
`RR:    case(isn[`INSTRUCTION_S2])
        `R1:       Source2Valid = TRUE;
        `SHIFT:	   Source2Valid = isn[25] ? 1'b1 : isn[`INSTRUCTION_RB]==6'd0;
        `SHIFTH:   Source2Valid = isn[25] ? 1'b1 : isn[`INSTRUCTION_RB]==6'd0;
        `SHIFTC:   Source2Valid = isn[25] ? 1'b1 : isn[`INSTRUCTION_RB]==6'd0;
        `SHIFTB:   Source2Valid = isn[25] ? 1'b1 : isn[`INSTRUCTION_RB]==6'd0;
        `LVX,`SVX: Source2Valid = FALSE;
        default:   Source2Valid = isn[`INSTRUCTION_RB]==6'd0;
        endcase
...
`QOPI:	Source2Valid = isn[`INSTRUCTION_RB]==6'd0;
...
`SB:    Source2Valid = isn[`INSTRUCTION_RB]==6'd0;
`SC:    Source2Valid = isn[`INSTRUCTION_RB]==6'd0;
`SH:    Source2Valid = isn[`INSTRUCTION_RB]==6'd0;
`SW:    Source2Valid = isn[`INSTRUCTION_RB]==6'd0;
`SWC:   Source2Valid = isn[`INSTRUCTION_RB]==6'd0;
`CAS:   Source2Valid = isn[`INSTRUCTION_RB]==6'd0;
`JAL:   Source2Valid = TRUE;
`RET:   Source2Valid = isn[`INSTRUCTION_RB]==6'd0;
`VECTOR:
		    case(isn[`INSTRUCTION_S2])
            ...
            `VADDS,`VSUBS,`VANDS,`VORS,`VXORS:
                Source2Valid = isn[`INSTRUCTION_RB]==6'd0;
            `VBITS2V:   Source2Valid = TRUE;
            `V2BITS:    Source2Valid = isn[`INSTRUCTION_RB]==6'd0;
            `VSHL,`VSHR,`VASR:  Source2Valid = isn[22:21]==2'd2;
            default:    Source2Valid = FALSE;
            endcase
`LV:        Source2Valid = TRUE;
`SV:        Source2Valid = FALSE;
`AMO:		Source2Valid = isn[31] || isn[`INSTRUCTION_RB]==6'd0;
...
`VECTOR:
    ...
    endcase
`BccR:  Source3Valid = isn[`INSTRUCTION_RC]==6'd0;
`BCHK:  Source3Valid = isn[`INSTRUCTION_RC]==6'd0;
`CHK:   Source3Valid = isn[`INSTRUCTION_RC]==6'd0;
`RR:
    case(isn[`INSTRUCTION_S2])
    `SBX:       Source3Valid = isn[`INSTRUCTION_RC]==6'd0;
    `SCX:       Source3Valid = isn[`INSTRUCTION_RC]==6'd0;
    `SHX:       Source3Valid = isn[`INSTRUCTION_RC]==6'd0;
    `SWX:       Source3Valid = isn[`INSTRUCTION_RC]==6'd0;
    `SWCX:      Source3Valid = isn[`INSTRUCTION_RC]==6'd0;
    `CASX:      Source3Valid = isn[`INSTRUCTION_RC]==6'd0;
    `CMOVEQ,`CMOVNE,`MAJ:  Source3Valid = isn[`INSTRUCTION_RC]==6'd0;
    default:    Source3Valid = TRUE;
    endcase
default:    Source3Valid = TRUE;
endcase
...
`FLOAT:
    ...
    endcase
`ADDI,`DIVI,`MODI,`MULI,`CHK:
    fnCanException = `TRUE;
`RR:
    case(isn[`INSTRUCTION_S2])
    `ADD,`SUB,`CHK,`MUL,`DIVMOD,`MULSU,`DIVMODSU:   fnCanException = TRUE;
...
//
    ...
    reg [63:0] csr_r;
    always @*
        read_csr(alu0_instr[34:20],csr_r,alu0_instr[39] ? 1'b0 : alu0_thrd);
...
wire [63:0] fcu_brdisp1 = {{49{fcu_instr[39]}},fcu_instr[39:25]};
wire [63:0] fcu_brdisp = {fcu_brdisp1,2'b00} + fcu_brdisp1;
...
assign  fcu_misspc =
    ...
    (fcu_instr[`INSTRUCTION_OP] == `CHK) ? (fcu_pc + 32'd5 + fcu_argI) :
    (fcu_instr[`INSTRUCTION_OP] == `BccR) ? (~fcu_takb ? fcu_pc + 5 : fcu_argC) :
                                            (~fcu_takb ? fcu_pc + 5 : fcu_pc + 5 + 
                                            fcu_brdisp);
...
`ifdef SUPPORT_SMT		            
                    ...
                    rs_stack[thread] <= {rs_stack[thread][55:0],rgs[thread]};
                    mstatus[thread][19:14] <= 6'd0;
                    cause[{thread,3'd0}] <= iqentry_res[head];
                    mstatus[thread][5:3] <= 3'd0;
	                mstatus[thread][13:6] <= 8'h00;
...
`endif   
    ...
    `CSR_BADADR:    dat <= badaddr[{thread,csrno[14:12]}];
    `CSR_CAUSE:     dat <= cause[{thread,csrno[14:12]}];
`ifdef SUPPORT_SMT    
    ...
    `CSR_GOLEX0:	dat <= golex[thread][63:0];
    `CSR_GOLEX1:	dat <= golex[thread][127:64];
    `CSR_GOLEX2:	dat <= golex[thread][191:128];
    `CSR_GOLEX3:	dat <= golex[thread][255:192];
    `CSR_GOLEXVP:	dat <= (golex[thread][cause[{thread,csrno[14:12]}][7:0]])|cause[{thread,csrno[14:12]}][63:8];
...
`else
    ...
    `CSR_GOLEX0:	dat <= golex[63:0];
    `CSR_GOLEX1:	dat <= golex[127:64];
    `CSR_GOLEX2:	dat <= golex[191:128];
    `CSR_GOLEX3:	dat <= golex[255:192];
    `CSR_GOLEXVP:	dat <= golex[cause[{thread,csrno[14:12]}][7:0]]|cause[{thread,csrno[14:12]}][63:8];
    `CSR_EPC0:      dat <= epc0;
    `CSR_EPC1:      dat <= epc1;
    `CSR_EPC2:      dat <= epc2;
    `CSR_EPC3:      dat <= epc3;
...
`endif    
    ...
    2'd1:   // CSRRW
        ...
        `CSR_CAUSE:     cause[{thread,csrno[13:11]}] <= dat;
`ifdef SUPPORT_DBG        
...
`ifdef SUPPORT_SMT        
        ...
        `CSR_GOLEX0:	golex[thread][63:0] <= dat;
        `CSR_GOLEX1:	golex[thread][127:64] <= dat;
        `CSR_GOLEX2:	golex[thread][191:128] <= dat;
        `CSR_GOLEX3:	golex[thread][255:192] <= dat;
...
`else
        ...
        `CSR_GOLEX0:	golex[63:0] <= dat;
        `CSR_GOLEX1:	golex[127:64] <= dat;
        `CSR_GOLEX2:	golex[191:128] <= dat;
        `CSR_GOLEX3:	golex[255:192] <= dat;
        `CSR_EPC0:      epc0 <= dat;
        `CSR_EPC1:      epc1 <= dat;
        `CSR_EPC2:      epc2 <= dat;
        `CSR_EPC3:      epc3 <= dat;
