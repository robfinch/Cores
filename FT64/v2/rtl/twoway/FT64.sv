...
wire P0 = iqentry_instr[head0][`INSTRUCTION_OP]==`CHK ? 1'b1 : iqentry_instr[head0][`INSTRUCTION_OP]==`BccR ? iqentry_instr[head0][27] : iqentry_instr[head0][0];  
wire P1 = iqentry_instr[head1][`INSTRUCTION_OP]==`CHK ? 1'b1 : iqentry_instr[head1][`INSTRUCTION_OP]==`BccR ? iqentry_instr[head1][27] : iqentry_instr[head1][0];  
wire BA = fetchbufA_instr[`INSTRUCTION_OP]==`CHK ? 1'b0 : fetchbufA_instr[`INSTRUCTION_OP]==`BccR ? fetchbufA_instr[26] : fetchbufA_instr[20];
wire BB = fetchbufB_instr[`INSTRUCTION_OP]==`CHK ? 1'b0 : fetchbufB_instr[`INSTRUCTION_OP]==`BccR ? fetchbufB_instr[26] : fetchbufB_instr[20];
wire BC = fetchbufC_instr[`INSTRUCTION_OP]==`CHK ? 1'b0 : fetchbufC_instr[`INSTRUCTION_OP]==`BccR ? fetchbufC_instr[26] : fetchbufC_instr[20];
wire BD = fetchbufD_instr[`INSTRUCTION_OP]==`CHK ? 1'b0 : fetchbufD_instr[`INSTRUCTION_OP]==`BccR ? fetchbufD_instr[26] : fetchbufD_instr[20];
wire SPA = fetchbufA_instr[`INSTRUCTION_OP]==`CHK ? 1'b1 : fetchbufA_instr[`INSTRUCTION_OP]==`BccR ? fetchbufA_instr[27] : fetchbufA_instr[0];
wire SPB = fetchbufB_instr[`INSTRUCTION_OP]==`CHK ? 1'b1 : fetchbufB_instr[`INSTRUCTION_OP]==`BccR ? fetchbufB_instr[27] : fetchbufB_instr[0];
wire SPC = fetchbufC_instr[`INSTRUCTION_OP]==`CHK ? 1'b1 : fetchbufC_instr[`INSTRUCTION_OP]==`BccR ? fetchbufC_instr[27] : fetchbufC_instr[0];
wire SPD = fetchbufD_instr[`INSTRUCTION_OP]==`CHK ? 1'b1 : fetchbufD_instr[`INSTRUCTION_OP]==`BccR ? fetchbufD_instr[27] : fetchbufD_instr[0];
...
`PBcc,`Bcc:   Source1Valid = isn[`INSTRUCTION_RA]==5'd0;
`BccR:  Source1Valid = isn[`INSTRUCTION_RA]==5'd0;
`PBBc,`BBc:   Source1Valid = isn[`INSTRUCTION_RA]==5'd0;
`PBEQI,`BEQI:  Source1Valid = isn[`INSTRUCTION_RA]==5'd0;
...
`PBcc,`Bcc:   Source2Valid = isn[`INSTRUCTION_RB]==5'd0;
`BccR:  Source2Valid = isn[`INSTRUCTION_RB]==5'd0;
`PBBc,`BBc:   Source2Valid = TRUE;
`PBEQI,`BEQI:  Source2Valid = TRUE;
...
case(isn[`INSTRUCTION_OP])
`BRK:   HasConst = FALSE;
`PBcc,`Bcc:   HasConst = FALSE;
`BccR:  HasConst = FALSE;
`PBBc,`BBc:   HasConst = FALSE;
`PBEQI,`BEQI:  HasConst = FALSE;
`RR:    HasConst = FALSE;
/*
		case(isn[`INSTRUCTION_S2])
        `SHLI:  HasConst = TRUE;
...
`LFx:		HasConst12 = TRUE;
`SFx:		HasConst12 = TRUE;
`MULDIV:	HasConst12 = TRUE;
`SccI:		HasConst12 = TRUE;
default:	HasConst12 = FALSE;
endcase
endfunction
...
`RR:    case(isn[`INSTRUCTION_S2])
        ...
        endcase
`PBcc,`Bcc:   IsFlowCtrl = TRUE;
`BccR:  IsFlowCtrl = TRUE;
`PBBc,`BBc:  IsFlowCtrl = TRUE;
`PBEQI,`BEQI:  IsFlowCtrl = TRUE;
`CHK:   IsFlowCtrl = TRUE;
`JAL:    IsFlowCtrl = TRUE;
`JMP:	IsFlowCtrl = TRUE;
...
//else
	...
	iqentry_imm  [tail]    <= HasConst(fetchbuf0_instr)|HasConst12(fetchbuf0_instr);
	iqentry_a0   [tail]    <= HasConst12(fetchbuf0_instr) ?
		{{52{fetchbuf0_instr[27]}},fetchbuf0_instr[27:16]}}} :
		{{48{fetchbuf0_instr[`INSTRUCTION_SB]}},fetchbuf0_instr[31:16]};
...
//    else
	...
	iqentry_ven  [tail]    <=   venno;
	iqentry_exc  [tail]    <=   `EXC_NONE;
	iqentry_imm  [tail]    <= HasConst(fetchbuf1_instr)|HasConst12(fetchbuf1_instr);
	iqentry_a0   [tail]    <= HasConst12(fetchbuf1_instr) ?
		{{52{fetchbuf1_instr[27]}},fetchbuf1_instr[27:16]}}} :
		{{48{fetchbuf1_instr[`INSTRUCTION_SB]}},fetchbuf1_instr[31:16]};
