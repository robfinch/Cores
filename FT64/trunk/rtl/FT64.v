...
assign Rt0b = fnRt2(fetchbuf0_instr,vqe);
...
assign Rt1b = fnRt2(fetchbuf1_instr,vqe);
...
input [31:0] fb_instr;
begin
    if (IsShifti(fb_instr)||IsVShift(fb_instr)||IsSEI(fb_instr))
