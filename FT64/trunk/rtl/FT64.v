...
BIDLE:
    begin
        ...
        else if (!dram0_unc && dram0==2'd1 && !dhit0 && IsLoad(dram0_instr)) begin
            dram0 <= 2'd2;
            bwhich <= 2'b00;
            cyc_o <= `HIGH;
            stb_o <= `HIGH;
        ...
        else if (!dram1_unc && dram1==2'd1 && !dhit1 && IsLoad(dram1_instr)) begin
            dram1 <= 2'd2;
            bwhich <= 2'b01;
            cyc_o <= `HIGH;
            stb_o <= `HIGH;
        ...
        else if (!dram2_unc && dram2==2'd1 && !dhit2 && IsLoad(dram2_instr)) begin
            dram2 <= 2'd2;
            bwhich <= 2'b10;
            cyc_o <= `HIGH;
            stb_o <= `HIGH;
