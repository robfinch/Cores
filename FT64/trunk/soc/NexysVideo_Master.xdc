...
create_generated_clock -name clk25 -source [get_pins ucg1/clk_in1] -multiply_by 8 -divide_by 32 [get_pins ucg1/clk80]
create_generated_clock -name clk80 -source [get_pins ucg1/clk_in1] -multiply_by 8 -divide_by 10 [get_pins ucg1/clk80]
create_generated_clock -name clk100 -source [get_pins ucg1/clk_in1] [get_pins ucg1/clk100]
create_generated_clock -name clk400 -source [get_pins ucg/clk_in1] -multiply_by 8 -divide_by 2 [get_pins ucg1/clk400]
#set_false_path -from [All_clocks] -to [All_clocks]
set_false_path -from [get_clocks clk25] -to [get_clocks [list clk80 clk100 clk400]] 
set_false_path -from [get_clocks clk80] -to [get_clocks [list clk25 clk100 clk400]] 
set_false_path -from [get_clocks clk100] -to [get_clocks [list clk25 clk80 clk400]] 
set_false_path -from [get_clocks clk400] -to [get_clocks [list clk25 clk80 clk100]] 
