...
wire peBltDstWidx;
wire cs_bltCtrl = (cs & we_i & (rdy2|rdy3) & ~rdy4) && adr_i[12:3]==10'b0110_1100_11 && |sel_i[1:0];
wire cs_bltAdatx = (cs & we_i & (rdy2|rdy3) & ~rdy4) && adr_i[12:3]==10'b0110_1000_11 && |sel_i[1:0];
wire cs_bltBdatx = (cs & we_i & (rdy2|rdy3) & ~rdy4) && adr_i[12:3]==10'b0110_1001_11 && |sel_i[1:0];
wire cs_bltCdatx = (cs & we_i & (rdy2|rdy3) & ~rdy4) && adr_i[12:3]==10'b0110_1010_11 && |sel_i[1:0];
wire cs_bltDdatx = (cs & we_i & (rdy2|rdy3) & ~rdy4) && adr_i[12:3]==10'b0110_1011_11 && |sel_i[1:0];
wire cs_bltDbadrx = (cs & we_i & (rdy2|rdy3) & ~rdy4) && adr_i[12:3]==10'b0110_1011_00 && |sel_i[1:0];
wire cs_bltDbmodx = (cs & we_i & (rdy2|rdy3) & ~rdy4) && adr_i[12:3]==10'b0110_1011_01 && |sel_i[1:0];
wire cs_bltDbcntx = (cs & we_i & (rdy2|rdy3) & ~rdy4) && adr_i[12:3]==10'b0110_1011_10 && |sel_i[1:0];
wire cs_bltDstWidx = (cs & we_i & (rdy2|rdy3) & ~rdy4) && adr_i[12:3]==10'b0110_1100_01 && |sel_i[1:0];
...
begin
	if (cs & we_i & (rdy2|rdy3) & ~rdy4)
		casez(adr_i[12:3])
		10'b00????????:	sprite_color[adr_i[10:3]] <= dat_i;
		10'b010?????00:	spriteAddr[adr_i[9:5]] <= dat_i;
		10'b010?????01:	begin
						if (|sel_i[1:0]) spriteMcnt[adr_i[9:5]] <= dat_i[15:0];
						if (sel_i[3]) sprite_pz[adr_i[9:5]] <= dat_i[31:24];
						end
		10'b010?????10:	begin
							if (|sel_i[1:0]) sprite_ph[adr_i[9:5]] <= dat_i[11:0];
							if (|sel_i[3:2]) sprite_pv[adr_i[9:5]] <= dat_i[27:16];
						end
		...
		10'b0110_1110_01:	cmdq_in[63:32] <= dat_i;
...
always @(posedge clk_i)
	...
	10'b0110_1110_10:	dat_o <= {22'd0,cmdq_wcnt};
