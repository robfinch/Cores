...
Instruction opl[] =
{   
	{"mov", op_mov,1,true,false,RC_ALL,RC_ALL,0,0},
	{"move",op_move,1,true},
	{"add",op_add,1,true,false,RC_GP,RC_GP,RC_GP,0},
	{"addu", op_addu,1,true},
	{"ldi",op_ldi,1,true,false,RC_GP,0,0,0},
	{"addi",op_addi,1,true},
	{"lw", op_lw,4,true,true,RC_GP,RC_GP,0,0},
	{"sw", op_sw,4,false,true,RC_GP,RC_GP,0,0},
	{"call", op_call,4,true,true,0,0,0,0},
	{"ret", op_ret,1,false,0,0,0,0},
	{"sub",op_sub,1,true,false,RC_GP,RC_GP,RC_GP,0},
	{"subu", op_subu,1,true},
	{"subi",op_subi,1,true},
	{"and",op_and,1,true,false,RC_GP,RC_GP,RC_GP,0},
	{"andi", op_andi,1,true},
	{"or",op_or,1,true,false,RC_GP,RC_GP,RC_GP,0 },
	{"ori",op_ori,1,true},
	{"eor",op_eor,1,true,false,RC_GP,RC_GP,RC_GP,0 },
	{"eori", op_eori,1,true},
	{"xor",op_xor,1,true,false,RC_GP,RC_GP,RC_GP,0 },
	{"xori", op_xori,1,true},
	{"divi", op_divi,68,true},
	{"modi", op_modi,68,true},
	{"modui", op_modui,68,true},
	{"div", op_div,68,true,false,RC_GP,RC_GP,RC_GP,0 },
	{"subui",op_subui},
	{"shru", op_shru,2,true,false,RC_GP,RC_GP,RC_GP,0 },
	{"divsi", op_divsi,68,true},
	{"not", op_not,2,true,false,RC_GP,RC_GP,0,0 },
	{"addui",op_addui,1,true},
	{"dw", op_dw},
	{"bfext", op_bfext,2,true},
	{"bfextu", op_bfextu,2,true},
	{"bfins", op_bfins,2,true},
	{"lh", op_lh,4,true,true,RC_GP,RC_GP,0,0},
	{"lc", op_lc,4,true,true,RC_GP,RC_GP,0,0 },
	{"lb", op_lb,4,true,true,RC_GP,RC_GP,0,0 },
	{"lbu", op_lbu,4,true,true,RC_GP,RC_GP,0,0 },
	{"lcu", op_lcu,4,true,true,RC_GP,RC_GP,0,0 },
	{"lhu", op_lhu,4,true,true,RC_GP,RC_GP,0,0 },
	{ "lvbu", op_lvbu,4,true,true ,RC_GP,RC_GP,0,0 },
	{ "lvcu", op_lvcu,4,true,true ,RC_GP,RC_GP,0,0 },
	{ "lvhu", op_lvhu,4,true,true ,RC_GP,RC_GP,0,0 },
	{"sti", op_sti},
	{"lft", op_lft},
	{"sft", op_sft},
	...
	{"sws", op_sws},
	{"lm", op_lm}, {"sm",op_sm},
	{"sb",op_sb,4,false,true,RC_GP,RC_GP,0,0 },
	{"sc",op_sc,4,false,true,RC_GP,RC_GP,0,0 },
	{"sh",op_sh,4,false,true,RC_GP,RC_GP,0,0 },
	{"sptr", op_sptr,4,false,true,RC_GP,RC_GP,0,0 },
	{"spt", op_spt,4,false,true ,RC_GP,RC_GP,0,0 },
	{"setwb", op_setwb, 1, false },

	{"loop", op_loop},
	{"jal", op_jal,1,true},

	{"cmp",op_cmp,1,true,false,RC_GP,RC_GP,RC_GP,0},
	{"cmpu",op_cmpu,1,true,false,RC_GP,RC_GP,RC_GP,0 },
	// Branches
	// Branches weighted as 3 because they might cause a pipeline flush
	{"beq", op_beq,3,false,false,RC_GP,RC_GP,0,0},
	{"bne", op_bne,3,false,false,RC_GP,RC_GP,0,0 },
	{"blt", op_blt,3,false,false,RC_GP,RC_GP,0,0 },
	{"ble", op_ble, 3, false,false,RC_GP,RC_GP,0,0 },
	{ "bgt", op_bgt,3,false ,false,RC_GP,RC_GP,0,0 },
	{ "bge", op_bge,3,false ,false,RC_GP,RC_GP,0,0 },
	{ "bltu", op_bltu,3,false ,false,RC_GP,RC_GP,0,0 },
	{ "bleu", op_bleu,3,false ,false,RC_GP,RC_GP,0,0 },
	{ "bgtu", op_bgtu,3,false ,false,RC_GP,RC_GP,0,0 },
	{ "bgeu", op_bgeu,3,false ,false,RC_GP,RC_GP,0,0 },
	{ "bbs", op_bbs,3,false ,false,RC_GP,0,0,0 },
	{ "bbc", op_bbc,3,false ,false,RC_GP,0,0,0 },
	{ "bor", op_bor,3,false },
	{ "beqi", op_beqi,3,false ,false,RC_GP,0,0,0 },
	{ "bchk", op_bchk,3,false },
	{ "ibne", op_ibne,3,true ,false,RC_GP,RC_GP,0,0 },
	{ "rtd", op_rtd },
	{ "lwr", op_lwr,4,true,true,RC_GP,RC_GP,0,0 },
	{ "swc", op_swc,4,false,true, RC_GP, RC_GP,0,0 },
	{ "cache",op_cache },
	{ "iret", op_iret,2,false,false,0,0,0,0 },
	{ "mul",op_mul,18,true,false,RC_GP,RC_GP,RC_GP,0},
	{ "muli", op_muli,18,true },
	{ "mului", op_mului,18,true },

	{ "fmul", op_fdmul,true,false,RC_FP,RC_FP,RC_FP,0 },
	{ "fdiv", op_fddiv,true,false,RC_FP,RC_FP,RC_FP,0 },
	{ "fadd", op_fdadd,true,false,RC_FP,RC_FP,RC_FP,0 },
	{ "fsub", op_fdsub,true,false,RC_FP,RC_FP,RC_FP,0 },
	{ "fcmp", op_fcmp, true,false,RC_FP,RC_FP,RC_FP,0 },
	{ "fmul.s", op_fsmul },
	{ "fdiv.s", op_fsdiv },
	{ "fadd.s", op_fsadd },
	{ "fsub.s", op_fssub },
	{ "fs2d", op_fs2d },
	{ "fi2d", op_i2d },
	{ "fneg", op_fneg,true,false,RC_FP,RC_FP,0,0 },
	...
	{ "gt",op_gt }, { "ge",op_ge },
	{ "neg",op_neg, true, false,RC_GP,RC_GP,0,0 },
	{ "nr", op_nr },
	{ "not",op_not,2,true, false,RC_GP, RC_GP,0,0 },
	{ "com", op_com,2,true,false,RC_GP,RC_GP,0,0 },
	{ "ext",op_ext },
	{ "zxh",op_zxh,1,true,false,RC_GP,RC_GP,0,0 },
	{ "zxc",op_zxc,1,true,false,RC_GP,RC_GP,0,0 },
	{ "zxb",op_zxb,1,true,false,RC_GP,RC_GP,0,0 },
	{ "sxh",op_sxh,1,true,false,RC_GP,RC_GP,0,0 },
	{ "sxc",op_sxc,1,true,false,RC_GP,RC_GP,0,0 },
	{ "sxb",op_sxb,1,true,false,RC_GP,RC_GP,0,0 },
	{ "jmp",op_jmp,1,false,false },
	{ "lea",op_lea,1,true,false,RC_GP,RC_GP,RC_GP,0 },

	{ "link",op_link,4,true,true },
	{ "unlink",op_unlk,4,true,true },
	{ "br",op_br,3,false,false,0,0,0,0 },
	{ "bra",op_bra,3,false,false,0,0,0,0 },
	{ "pea",op_pea },
	{ "cmpi",op_cmpi,1,true },
	{ "tst",op_tst,1,true },
	...
	{ "slt", op_slt,1,true,false,RC_GP,RC_GP,RC_GP,0 },
	{ "sle",op_sle,1,true,false,RC_GP,RC_GP,RC_GP,0 },
	{ "sgt",op_sgt,1,true,false,RC_GP,RC_GP,RC_GP,0 },
	{ "sge",op_sge,1,true,false,RC_GP,RC_GP,RC_GP,0 },
	{ "sltu", op_sltu,1,true,false,RC_GP,RC_GP,RC_GP,0 },
	{ "sleu",op_sleu,1,true,false,RC_GP,RC_GP,RC_GP,0 },
	{ "sgtu",op_sgtu,1,true,false,RC_GP,RC_GP,RC_GP,0 },
	{ "sgeu",op_sgeu,1,true,false,RC_GP,RC_GP,RC_GP,0 },

	{ "",op_empty }, { "",op_asm,100 }, { "", op_fnname },
	{ "ftadd", op_ftadd }, { "ftsub", op_ftsub }, { "ftmul", op_ftmul }, { "ftdiv", op_ftdiv },
	{ "inc", op_inc,1,false }, { "dec", op_dec,1,false },

	{ "bsr", op_bsr },

		// Shifts
		// Shifts are weighted as 2 because they can only execute on one ALU
	{ "asr",op_asr,2,true,false,RC_GP,RC_GP,RC_GP,0 },
	{ "asri", op_asri,2,true,false,RC_GP,RC_GP,0,0 },
	{ "shl", op_shl,2,true,false,RC_GP,RC_GP,RC_GP,0 },
	{ "shr", op_shr,2,true,false,RC_GP,RC_GP,RC_GP,0 },
	{ "shru", op_shru,2,true,false,RC_GP,RC_GP,RC_GP,0 },
	{ "shlu", op_shlu,2,true,false,RC_GP,RC_GP,RC_GP,0 },
	{ "shlui", op_shlui,2,true },
	{ "shli", op_shli,2,true },
	{ "shri", op_shri,2,true },
	{ "shrui", op_shrui,2,true },
	{ "ror", op_ror,2,true,false,RC_GP,RC_GP,RC_GP,0 },
	{ "rori", op_rori,2,true },
	{ "rol", op_rol,2,true,false,RC_GP,RC_GP,RC_GP,0 },
	{ "roli", op_roli,2,true },
	{ "sll", op_sll,2,true,false,RC_GP,RC_GP,RC_GP,0 },
	{ "slli", op_slli,2,true },
	{ "srl", op_srl,2,true,false,RC_GP,RC_GP,RC_GP,0 },
	{ "srli", op_srli,2,true },
	{ "sra", op_sra,2,true,false,RC_GP,RC_GP,RC_GP,0 },
	{ "srai", op_srai,2,true },
	{ "asl", op_asl,2,true,false,RC_GP,RC_GP,RC_GP,0 },
	{ "asli", op_asli,2,true },
	{ "lsr", op_lsr,2,true,false,RC_GP,RC_GP,RC_GP,0 },
	{ "lsri", op_lsri,2,true },
	...
	{ "fcvtdq", op_fcvtdq },
	{ "fcvttq", op_fcvttq },
	{ "sf", op_sf, false, true, RC_FP, RC_GP, 0, 0 },
	{ "lf", op_lf, true, true, RC_FP, RC_GP, 0, 0 },
	{ "sfd", op_sfd },
	{ "lfd", op_lfd },
	{ "fmov.d", op_fdmov },
	{ "fmov", op_fmov },
	{ "fadd", op_fadd, true, false, RC_FP, RC_FP, RC_FP, 0 },
	{ "fsub", op_fsub, true, false, RC_FP, RC_FP, RC_FP, 0 },
	{ "fmul", op_fmul, true, false, RC_FP, RC_FP, RC_FP, 0 },
	{ "fdiv", op_fdiv, true, false, RC_FP, RC_FP, RC_FP, 0 },
	{ "ftoi", op_ftoi, true, false, RC_GP, RC_FP, 0, 0 },
	{ "itof", op_itof, true, false, RC_FP, RC_GP, 0, 0 },
	...
	{ "vadd", op_vadd,10,true,false, RC_VEC,RC_VEC,RC_VEC,0 },
	{ "vsub", op_vsub,10,true,false, RC_VEC,RC_VEC,RC_VEC,0 },
	{ "vmul", op_vmul,10,true,false, RC_VEC,RC_VEC,RC_VEC,0 },
	{ "vdiv", op_vdiv,100,true,false, RC_VEC,RC_VEC,RC_VEC,0 },
	{ "vseq", op_vseq,10 },
	{ "vsne", op_vsne,10 },
	{ "vslt", op_vslt,10 },
	{ "vsge", op_vsge,10 },
	...
	{ "redor", op_redor,2,true,false,RC_GP,RC_GP,RC_GP,0 },
	{ "brk", op_brk,1,false },
	{ "rti", op_rti,2,false },
	{ "rte", op_rte,2,false },
	{ "nand",op_nand,1,true,false,RC_GP,RC_GP,RC_GP,0 },
	{ "nor",op_nor,1,true,false,RC_GP,RC_GP,RC_GP,0 },
	{ "xnor",op_xnor,1,true,false,RC_GP,RC_GP,RC_GP,0 },
