...
module FT64v8d_L1_icache_mem(rst, clk, wr, lineno, i, o, ov, invall, invline);
parameter pLines = 128;
parameter pLineWidth = 641;
...
always  @(posedge clk)
    if (wr)  mem[lineno][641:0] <= i[641:0];
always  @(posedge clk)
if (rst) begin
     valid <= 128'd0;
end
...
module FT64v8d_L1_icache_cmptag4way(rst, clk, nxt, wr, adr, lineno, hit);
parameter pLines = 128;
parameter AMSB = 31;
localparam pLNMSB = pLines==128 ? 6 : 5;
...
module FT64v8d_L1_icache(rst, clk, nxt, wr, wr_ack, wadr, adr, i, o, fault, hit, invall, invline);
parameter pSize = 8;
parameter AMSB = 31;
...
FT64v8d_L1_icache_mem #(.pLines(pLines)) u1
(
  .rst(rst),
  .clk(clk),
  .wr(wr1),
...
FT64v8d_L1_icache_cmptag4way #(.pLines(pLines)) u3
(
	.rst(rst),
	.clk(clk),
	.nxt(nxt),
...
module FT64v8d_L2_icache_mem(clk, wr, lineno, sel, i, fault, o, ov, invall, invline);
input clk;
input wr;
input [8:0] lineno;
input [2:0] sel;
...
begin
  if (wr) begin
    ...
    4'd8:    begin mem8[lineno] <= i; memf[lineno] <= memf[lineno] | fault; end
    4'd9:    begin mem9[lineno] <= i; memf[lineno] <= memf[lineno] | fault; end
    endcase
  end
end
...
module FT64v8d_L2_icache(rst, clk, nxt, wr, wr_ack, rd_ack, xsel, adr, cnt, exv_i, i, err_i, o, hit, invall, invline);
parameter AMSB = 31;
input rst;
input clk;
input nxt;
...
FT64v8d_L2_icache_cmptag4way u2
(
	.rst(rst),
	.clk(clk),
	.nxt(nxt),
...
module FT64v8d_L2_icache_cmptag4way(rst, clk, nxt, wr, adr, lineno, hit);
parameter AMSB = 31;
input rst;
input clk;
input nxt;
