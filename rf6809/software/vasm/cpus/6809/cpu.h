...
typedef struct {
  uint16_t ocidx; /* opcode index STD,DIR,IDX,EXT */
  uint16_t dp;    /* remember current direct page per instruction */
} instruction_ext;
...
enum {
  ...
  REG_A=8,REG_B=9,REG_CC=10,REG_DP=11,REG_USPG=12,
...
#define R_DCIX24        (1<<23)  /* index reg. with 24-bit constant offset */
#define R_ICIX24        (1<<24)  /* indir. index reg. with 24-bit const. offs. */

/* used to get any register */
#define R_ANY           (0xffffffff)

/* direct index registers with constant offset */
#define R_DCIDX         (R_DCIX0|R_DCIX5|R_DCIX8|R_DCIX16|R_DCIX24)

/* indirect index registers with constant offset */
#define R_ICIDX         (R_ICIX0|R_ICIX8|R_ICIX16|R_ICIX24)
...
#define R_CIX09         (R_DCIX0|R_DCIX5|R_DCIX8|R_DCIX16|R_ICIX0|R_ICIX8|R_ICIX16|R_ICIX24)
...
#define R_IDXPCR        (R_DCIX8|R_DCIX16|R_ICIX8|R_ICIX16|R_ICIX24)
