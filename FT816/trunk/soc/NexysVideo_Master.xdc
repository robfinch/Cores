...
create_generated_clock -name isys_clk -source [get_pins ucg1/u1/clkin1] -multiply_by 12 -divide_by 36 [get_pins ucg1/u1/clkout1]
create_generated_clock -name clk50u -source [get_pins ucg1/u1/clkin1] -multiply_by 12 -divide_by 24 [get_pins ucg1/u1/clkout4]
#set_false_path -from [All_clocks] -to [All_clocks]
set_false_path -from [get_clocks clk50u] -to [get_clocks [list isys_clk clk85u]] 
set_false_path -from [get_clocks clk85u] -to [get_clocks [list isys_clk clk50u]] 
#set_false_path -from [get_clocks clk_pll_i] -to [get_clocks [list isys_clk clk50u clk200u clk85u u2_n_2]] 
#set_false_path -from [get_clocks clk_pll_i] -to [get_clocks [list isys_clk clk50u clk200u clk85u u2_n_2]] 
set_false_path -from [get_clocks isys_clk] -to [get_clocks [list clk50u clk85u]]
