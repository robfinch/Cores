...
module FT816(rst, clk, cyc, phi1, phi2, rdy, be, bz, vpa, vda, rw, ad, db);
input rst;
input clk;
output reg [4:0] cyc;
output phi1;
...
`TSB_ABS,`TRB_ABS,`BIT_ABS,`BIT_ABSX,`JMP_ABS,`JMP_INDX,`STY_ABS,`STZ_ABS,`LDY_ABS,`LDY_ABSX,`CPY_ABS,
