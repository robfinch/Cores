...
void CLink::SetClassBit(int FirstCharOfLexeme)
{
   switch(FirstCharOfLexeme)
   {
      ...
      default:
         throw FatalErr(E_LINKSCBIT, FirstCharOfLexeme);
         break;
   }
}
...
char *CLink::GetPrefix()
{
   ...
   throw FatalErr(E_LINKPREFIX, TypeStr());
}
