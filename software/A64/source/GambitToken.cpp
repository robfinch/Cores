...
static int64_t tokenBuffer[5000000];
static int tbndx;
static char litpool[10000000];
static int lpndx = 0;
...
static int isspaceOrDot(char ch)
{
	ch &= 0x7f;
	return (my_isspace(ch) || ch=='.');
}

static int isFirstIdentChar(char ch)
{
	ch &= 0x7f;
  return (isalpha(ch) || ch=='_');
}

static int isIdentChar(char ch)
{
	ch &= 0x7f;
	return (isalnum(ch) || ch=='_');
}

extern int need(int tk);
