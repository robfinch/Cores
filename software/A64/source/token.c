...
int NextToken()
{
    ...
    do {
        ...
        // cas chk cmp cmpu code cli com cmpi
        case 'c': case 'C':
             if (gCpu==4) {
                 if ((inptr[1]=='m' || inptr[1]=='M') &&
                     (inptr[2]=='p' || inptr[2]=='P') &&
        ...
        // end eor eori endpublic extern equ es
        case 'e': case 'E':
        ...
        // rol roli ror rori rtd rte rtf rts rti rtl rodata
        case 'r': case 'R':
        ...
        // swcr sfd sts sync sws stcmp stmov srai srli
        case 's': case 'S':
            if ((inptr[1]=='w' || inptr[1]=='W') && isspace(inptr[2])) {
                inptr += 2;
                return token = tk_sw;
        ...
        // to tlbdis tlben tlbpb tlbrd tlbrdreg tlbwi tlbwr tlbwrreg
        case 't': case 'T':
             if ((inptr[1]=='o' || inptr[1]=='O') &&
                 isspace(inptr[2])) {
                 inptr += 2;
