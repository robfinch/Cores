...
/*
   if (lastsym != (SYM *)NULL)
       ...
       emitImm16(val,0);
*/
    emitImm22(val,lastsym!=(SYM*)NULL);
    if (bGen)
    if (lastsym && !use_gp) {
        if( lastsym->segment < 5)
...
static void process_rrop(int oc)
{
    ...
    if (token=='#') {
        ...
        case 8: process_riop(8); return;  // mulu
        case 9: process_riop(9); return;  // div
        case 10: process_riop(10); return;  // divu
        case 26: process_riop(26); return;  // mod
        case 27: process_riop(27); return;  // modu
        case 12: process_riop(12); return;  // and
        case 13: process_riop(13); return;  // or
        case 14: process_riop(14); return;  // eor
        // Shift
        case 24: process_shifti((oc & ~0x3F)|25); return;
        }
        return;
    }
    prevToken();
...
j1:
    ...
    if ((ad & 15)==15)
       ad++;
    if (Ra==63)
        disp = ((val & 0xFFFFFFFFFFFF0000L) - (ad & 0xFFFFFFFFFFFF0000L)) >> 16;
    else
        disp = val >> 16;
    emit_insn(
        (((disp & 0x1f) << 35)) |
...
//        printf("token=%d\r", token);
        ...
        case tk_add:  process_rrop(4); break;
        case tk_addi: process_riop(4); break;
        ...
        case tk_beq: process_bcc(BCC(6)); break;
        case tk_bge: process_bcc(BCC(13)); break;
        case tk_bgeu: process_bcc(BCC(9)); break;
        case tk_bgt: process_bcc(BCC(12)); break;
        case tk_bgtu: process_bcc(BCC(8)); break;
        case tk_ble: process_bcc(BCC(15)); break;
        case tk_bleu: process_bcc(BCC(11)); break;
        case tk_blt: process_bcc(BCC(14)); break;
        case tk_bltu: process_bcc(BCC(10)); break;
        case tk_bmi: process_bcc(BCC(0)); break;
        case tk_bne: process_bcc(BCC(7)); break;
        case tk_bpl: process_bcc(BCC(1)); break; // also brpl
        case tk_bra: process_bra(BCC(16)); break;
        case tk_brnz: process_bcc(BCC(19)); break;
        case tk_brz:  process_bcc(BCC(18)); break;
        case tk_bvc: process_bcc(BCC(3)); break;
        case tk_bvs: process_bcc(BCC(2)); break;
//        case tk_bsr: process_bra(0x56); break;
        ...
        case tk_cmp: process_rrop(6); break;
        ...
        case tk_mod: process_rrop(26); break;
        case tk_modu: process_rrop(27); break;
        case tk_mov: process_mov(0x04); break;
        case tk_mtfp: process_mtfp(0x4A); break;
        case tk_mtspr: process_mtspr(0x48); break;
        case tk_mul: process_rrop(7); break;
        case tk_muli: process_riop(7); break;
        case tk_mulu: process_rrop(8); break;
        case tk_mului: process_riop(8); break;
        ...
        case tk_sub:  process_rrop(5); break;
        case tk_subi: process_riop(5); break;
