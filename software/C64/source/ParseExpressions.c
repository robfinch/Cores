...
TYP             stdstring = {bt_pointer, bt_pointer, 1, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, 0,0,4, {0, 0}, &stdchar, 0};
TYP				stddbl = {bt_double, bt_double, 0, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, 0,0,8, {0, 0}, 0, 0};
TYP				stdtriple = {bt_triple, bt_triple, 0, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, 0,0,12, {0, 0}, 0, 0};
TYP				stdflt = {bt_float, bt_float, 0, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, 0,0,4, {0, 0}, 0, 0};
TYP				stddouble = {bt_double, bt_double, 0, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, 0,0,8, {0, 0}, 0, 0};
TYP             stdfunc = {bt_func, bt_func, 1, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, FALSE, 0,0,0, {0, 0}, &stdint, 0};
TYP             stdexception = { bt_exception, bt_exception, 0, FALSE, TRUE, FALSE, FALSE, FALSE, FALSE, FALSE, 0,0,8, {0, 0}, 0, 0 };
