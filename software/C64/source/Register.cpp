...
//    else if (isThor)
//		GenerateDiadic(op_sw,0,ap1,make_indx(stkpos,regSP));
	else {
...
//	else if (isThor)
//		GenerateDiadic(op_lw,0,ap1,make_indx(stkpos*8,regSP));
	else {
...
//	if (isThor)
//		GenerateTriadic(op_addui,0,makereg(regSP),makereg(regSP),make_immed(8*sp));
