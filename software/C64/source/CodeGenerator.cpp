...
extern AMODE *GenExprFISA64(ENODE *node);
extern AMODE *GenerateFISA64FunctionCall(ENODE *node, int flags);
extern void FISA64_GenLdi(AMODE*,AMODE *);
extern void GenerateFISA64Cmp(ENODE *node, int op, int label, int predreg);

extern AMODE *GenExpr816(ENODE *node);
extern void Generate816Binary(int op, AMODE *ap3, AMODE *ap1, AMODE *ap2);
extern AMODE *Generate816FunctionCall(ENODE *node, int flags);
extern void Generate816Cmp(ENODE *node, int op, int label, int predreg);
...
//                        GenerateDiadic(op_tst,siz1,ap1,0);
                        ...
                        if (isFISA64)
							...
							GeneratePredicatedMonadic(predreg,PredOp(op_ne),op_br,0,make_clabel(label));
						}
                        break;
                }
}
...
//                        GenerateDiadic(op_tst,siz1,ap,0);
                        ...
                        if (isFISA64)
							...
							GeneratePredicatedMonadic(predreg,PredOp(op_eq),op_br,0,make_clabel(label));
						}
                        break;
                }
}
