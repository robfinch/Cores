...
Operand *FT64CodeGenerator::GenExpr(ENODE *node)
{
  ...
  lab1 = nextlabel++;
	...
	case en_eq:
		...
		GenerateDiadic(op_ldi, 0, ap3, MakeImmediate(0));
		GenerateMonadic(op_bra, 0, MakeCodeLabel(lab1));
		GenerateLabel(lab0);
		GenerateDiadic(op_ldi, 0, ap3, MakeImmediate(1));
		GenerateLabel(lab1);
	...
	case en_ne:
		...
		GenerateTriadic(op_bne, 0, ap1, ap2, MakeCodeLabel(lab0));
		GenerateDiadic(op_ldi, 0, ap3, MakeImmediate(0));
		GenerateMonadic(op_bra, 0, MakeCodeLabel(lab1));
		GenerateLabel(lab0);
		GenerateDiadic(op_ldi, 0, ap3, MakeImmediate(1));
	...
	case en_ule:
		...
		ap1 = cg.GenerateExpression(node->p[0], am_reg, size);
		ap2 = cg.GenerateExpression(node->p[1], am_reg, size);
		GenerateTriadic(op_bltu, 0, ap1, ap2, MakeCodeLabel(lab0));
		GenerateTriadic(op_beq, 0, ap1, ap2, MakeCodeLabel(lab0));
		GenerateDiadic(op_ldi, 0, ap3, MakeImmediate(0));
		GenerateMonadic(op_bra, 0, MakeCodeLabel(lab1));
		GenerateLabel(lab0);
...
//		GenerateDiadic(op_sge,0,ap3,ap3);
	...
	case en_fgt:
		...
		ap1 = cg.GenerateExpression(node->p[0], am_fpreg, size);
		ap2 = cg.GenerateExpression(node->p[1], am_fpreg, size);
		GenerateTriadic(op_flt, ap1->fpsize(), ap3, ap2, ap1);
		ReleaseTempRegister(ap2);
		ReleaseTempRegister(ap1);
		ap3->isBool = true;
		return (ap3);
	case en_fge:
		...
		ap1 = cg.GenerateExpression(node->p[0], am_fpreg, size);
		ap2 = cg.GenerateExpression(node->p[1], am_fpreg, size);
		GenerateTriadic(op_fle, ap1->fpsize(), ap3, ap2, ap1);
		ReleaseTempRegister(ap2);
		ReleaseTempRegister(ap1);
		ap3->isBool = true;
		return (ap3);
	case en_fne:
		...
		ap1 = cg.GenerateExpression(node->p[0], am_fpreg, size);
		ap2 = cg.GenerateExpression(node->p[1], am_fpreg, size);
		GenerateTriadic(op_feq, ap1->fpsize(), ap3, ap1, ap2);
