...
{ "beqz", op_beqz,3,0,false,am_reg,0,0,0 },
...
{ "bnez", op_bnez,3,0,false,am_reg,0,0,0 },
...
{ "div", op_div,68,1,false,am_reg,am_reg,am_reg,0 },
{ "divu",op_divu,68,1,false,am_reg,am_reg,am_reg,0 },
{ "dw", op_dw },
...
{ "movs", op_movs },
{ "mtfp", op_mtfp },
{ "mul",op_mul,18,1,false,am_reg,am_reg,am_reg,0 },
{ "mulf",op_mulf,1,1,false,am_reg,am_reg,am_reg | am_imm,0 },
{ "mulu",op_mulu,10,1,false,am_reg,am_reg,am_reg,0 },
...
{ "rem", op_rem,68,1, false,am_reg,am_reg,am_reg,0 },
{ "remu", op_remu,68,1,false,am_reg,am_reg,am_reg,0 },
...
{ "sll", op_sll,2,1,false,am_reg,am_reg,am_reg|am_ui6,0 },
...
char *RegMoniker(int regno)
{
	...
	else if (regno>=regV0 && regno<=regV1)
		sprintf_s(&buf[n][0], 20, "$v%d", regno-regV0);
