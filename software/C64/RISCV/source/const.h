...
enum e_op {
	...
	op_mul, op_muli, op_mulu, op_divi, op_modi, op_modui, op_remu,
	...
	op_bmi, op_subu, op_lddr, op_stdc, op_loop, op_iret, op_pfi,
	...
	op_std, op_sto, op_stp, op_stt, op_stw, op_stb, op_outb, op_inb, op_inbu,
	op_sfd, op_lfd,
	...
	op_lft, op_sft,
	op_ldd, op_ldo, op_ldp, op_ldw, op_ldb, op_ret, op_sm, op_lm, op_ldis, op_ldds, op_stds,
