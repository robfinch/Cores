...
cam6x32 u1 (clk, we, wr_addr, din[ 5: 0], cmp_din[ 5: 0], match_addr0);
cam6x32 u2 (clk, we, wr_addr, din[11: 6], cmp_din[11: 6], match_addr1);
cam6x32 u3 (clk, we, wr_addr, din[17:12], cmp_din[17:12], match_addr2);
cam6x32 u4 (clk, we, wr_addr, din[23:18], cmp_din[23:18], match_addr3);
cam6x32 u5 (clk, we, wr_addr, din[29:24], cmp_din[29:24], match_addr4);
cam6x32 u6 (clk, we, wr_addr, din[35:30], cmp_din[35:30], match_addr5);
