...
`endif
		case(ir9)
		`TAS,`TXS:	begin isp <= {res[31:2],2'b00}; gie <= 1'b1; end
		`SUB_SP8,`SUB_SP16,`SUB_SP32:	isp <= {res[31:2],2'b00};
		`TRS:
			begin
				case(ir[15:12])
				4'h0:	begin
...
`endif
				...
				4'h5:	lfsr <= res[31:0];
				4'h7:	abs8 <= res[31:0];
				4'h8:	begin vbr <= {res[31:11],11'h000}; nmoi <= res[0]; end
				4'hE:	begin sp <= res[15:0]; spage[31:16] <= res[31:16]; end
				4'hF:	begin isp <= {res[31:2],2'b00}; gie <= 1'b1; end
				endcase
			end
		`RR:
			case(ir[23:20])
