...
TYP             stdint = { bt_long, bt_long, 0, FALSE, FALSE, FALSE, 0,0,1, {0, 0}, 0, 0 };
TYP             stduint = { bt_long, bt_long, 0, TRUE, FALSE, FALSE, 0,0,1, {0, 0}, 0, 0 };
TYP             stdlong = { bt_long, bt_long, 0, FALSE, FALSE, FALSE, 0,0,1, {0, 0}, 0, 0 };
TYP             stdulong = { bt_long, bt_long, 0, TRUE, FALSE, FALSE, 0,0,1, {0, 0}, 0, 0 };
TYP             stdshort = { bt_short, bt_short, 0, FALSE, FALSE, FALSE, 0,0,1, {0, 0}, 0, 0 };
TYP             stdushort = { bt_short, bt_short, 0, TRUE, FALSE, FALSE, 0,0,1, {0, 0}, 0, 0 };
TYP             stdchar = {bt_char, bt_char, 0, FALSE, FALSE, FALSE, 0,0,1, {0, 0}, 0, 0 };
TYP             stduchar = {bt_char, bt_char, 0, TRUE, FALSE, FALSE, 0,0,1, {0, 0}, 0, 0 };
...
TYP             stdstring = {bt_pointer, bt_pointer, 1, FALSE, FALSE, FALSE, 0,0,1, {0, 0}, &stdchar, 0};
TYP				stddbl = {bt_double, bt_double, 0, FALSE, FALSE, FALSE, 0,0,2, {0, 0}, 0, 0};
TYP				stdflt = {bt_float, bt_float, 0, FALSE, FALSE, FALSE, 0,0,1, {0, 0}, 0, 0};
...
ENODE *makenodei(int nt, ENODE *v1, __int32 i)
{
	ENODE *ep;
    ep = (ENODE *)xalloc(sizeof(ENODE));
    ep->nodetype = nt;
...
ENODE *makeinode(int nt, __int32 v1)
{
	ENODE *ep;
    ep = (ENODE *)xalloc(sizeof(ENODE));
    ep->nodetype = nt;
