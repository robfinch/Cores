...
static Opa stAsm[] =
{
	...
	{AsmRTF65002::absbit, 0x8D, 2, (AM_RN<<8)|AM_A,4},
	{AsmRTF65002::bit_absx, 0x9D, 2, (AM_RN<<8)|AM_AX,4},
	{AsmRTF65002::bit_absx, 0x9D, 2, (AM_RN<<8)|AM_AY,4},
	{AsmRTF65002::st_dsp, 0x83, 2, (AM_RN<<16)|(AM_RN<<8)|AM_SR,4},
...
static Opa sbAsm[] =
{
	{AsmRTF65002::sb_zp, 0x74, 2, (AM_RN<<8)|AM_Z,4},
	{AsmRTF65002::sb_zp, 0x74, 2, (AM_RN<<8)|AM_ZY,4},
    {AsmRTF65002::sb_zp, 0x74, 2,(AM_RN<<8)| AM_ZX,4},
	{AsmRTF65002::abssb, 0x9C, 2, (AM_RN<<8)|AM_A,4},
	{AsmRTF65002::sb_absx, 0x9E, 2, (AM_RN<<8)|AM_AX,4},
	{AsmRTF65002::sb_absx, 0x9E, 2, (AM_RN<<8)|AM_AY,4},
	NULL
};
...
static Opa staAsm[] =
{
	...
	{AsmRTF65002::abssta, 0x8D, 1, AM_A,4},
...
static Opa stzAsm[] =
{
	...
	{AsmRTF65002::stz_abs, 0x8D, 1, AM_A,4},
...
static Opa ldAsm[] =
{
	...
	{AsmRTF65002::ld_dsp, 0x03, 3, (AM_RN<<16)|(AM_RN<<8)|AM_SR,4},
