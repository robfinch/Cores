...
namespace RTFClasses
{
	...
	static Opa braAsm[] = {	{Asm6502::br, 0x80, 1}, NULL };
	static Opa brkAsm[] = {	{Asm6502::out8, 0x00, 0}, NULL };

	static Opa bitAsm[] =
	{
		{Asm6502::imm, 0x89, 1, AM_IMM},
		{Asm6502::zp, 0x24, 1, AM_Z},
		{Asm6502::zp, 0x34, 1, AM_ZX},
		{Asm6502::abs, 0x2C, 1, AM_A},
		{Asm6502::abs, 0x3C, 1, AM_AX},
		NULL
	};
	...
	static Opa natAsm[] = { {Asm6502::out8, 0xFB}, NULL };
...
static Opa stpAsm[] = { {Asm6502::out8, 0xDB}, NULL };
	...
	static Opa stzAsm[] =
	{
		{Asm6502::zp, 0x64, 1, AM_Z},
		{Asm6502::zp, 0x74, 1, AM_ZX},
		{Asm6502::abs, 0x9C, 1, AM_A},
		{Asm6502::abs, 0x9E, 1, AM_AX},
		NULL
	};
	...
	static Opa jmpAsm[] =
	{
		...
		{Asm6502::abs, 0x4c, 1, AM_Z},	// Force abs
		{Asm6502::abs, 0x6c, 1, AM_I},
		{Asm6502::abs, 0x7c, 1, AM_IX},
	...
	static Opa jmlAsm[] =
	{
		{Asm6502::jml_abs, 0x5c, 1, AM_A},
		NULL
	};
	static Opa jsrAsm[] =
	{
		{Asm6502::abs, 0x20, 1, AM_A} ,
		{Asm6502::abs, 0x20, 1, AM_Z},	// force abs
		NULL
	};
