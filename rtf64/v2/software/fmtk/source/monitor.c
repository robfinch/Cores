...
void help()
{
	DBGDisplayAsciiStringCRLF(
		B"Commands\r\n"
		"B Tiny BASIC\r\n"
		"C <address> - call subroutine\r\n"
		"D start debugger\r\n"
		"G graphics demo\r\n"
		"H Hex Loader\r\n"
		"M <address> <length> - dump memory\r\n"
		"X exit back to OS"
	);
}
...
static pascal int GetNum(int *ln)
{
	char buf[20];
	int count;
	int num;
