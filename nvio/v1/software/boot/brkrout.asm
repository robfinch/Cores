...
__BrkHandler:
		...
		csrrc	$r22,#$044,$r22
		csrrw	$r0,#$0BF,$r22			; save previous in a code buffer
		csrrd	$r22,#6,$r0					; Get cause code
		sb		$r22,LEDS
		ldi		$sp,#__brk_stack_top
;		call	_DBGHomeCursor
;		push	$r22
;		call	_DispByte
		and		$r22,$r22,#$FF
...
.ibeFlt:
		csrrd	$r22,#$048,$r0		; get EPC
		cache	#2,[$r22]					; invalidate line
		sync
		jmp		_return_from_interrupt
.lvl6:
		// Redirect to level #6
...
.callOS:
		...
		; Load the fault number and exception type into r1,r2 and return to the
		; exception handler.
.iChk:
		mov		$r1,$xlr:x
		beq		$r1,$r0,.noChkHandler
		csrrw	$r0,#EPC,$r1
		ldi		$r1,#FLT_CHK
		mov		$r1:x,$r1
		ldi		$r1,#33			; bt_exception from compiler
		mov		$r2:x,$r1
.noChkHandler:
		jmp		_return_from_interrupt
