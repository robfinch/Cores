...
module Table888_sys(btn, clk, Led, sw, kclk, kd,
...
wire [31:0] io_adr = {cpu_adr[33:18],cpu_adr[15:0]};
...
PS2kbd #(.pClkFreq(`CLK_FREQ)) ukbd1
(
...
wire cs_mem = cpu_adr[31:28]==4'h0 && cpu_adr[31:14]!=18'h000000 && cpu_adr[31:15]!=17'b00001;// || (thread_area_cs && thread_index!=8'h00);
