...
extern AMODE *make_ainc(int rg);
extern AMODE *make_adec(int rg);
extern AMODE *make_dreg(int rg);
extern AMODE *make_areg(int rg);
// IdentifyKeyword.c
...
extern AMODE *GetTempAddressReg();
extern AMODE *GetTempDataReg();
