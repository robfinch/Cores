...
#define F_POSTINC	65536
#define F_PREDEC	131072
#define F_AREG		262144
#define F_DREG		524288
#define F_ALL   (15|1024|F_AREG|F_DREG)      /* all modes allowed */
...
enum e_op {
        op_move, op_add, op_adda, op_addi, op_sub, op_subi, op_movem, op_mtspr, op_mfspr, op_ldi, op_ld,
...
enum e_am {
        am_dreg, am_areg, am_sreg, am_breg, am_fpreg, am_vreg, am_vmreg, am_ind, am_brind, am_ainc, am_adec, am_indx, am_indx2,
