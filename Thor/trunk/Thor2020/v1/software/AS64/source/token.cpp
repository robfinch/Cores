...
int NextToken()
{
    ...
    do {
      ...
      if (isdigit(ch)) {
        ...
        // ecall end eor eori endif endpublic extern equ eq eret es
        case 'e': case 'E':
       ...
       if (inptr[1]=='f' || inptr[1]=='F') {
			 ...
			 if (gCpu == RISCV) {
				 ...
				 if ((inptr[1] == 'n' || inptr[1] == 'N') &&
					 ...
					 isspace(inptr[6])) {
					 inptr += 6;
					 tokenBuffer[tbndx] = tk_insiof;
					 tbndx++;
					 return (token = tk_insiof);
				 }
			 }
			 break;
        ...
        case 'n': case 'N':
            ...
            if ((inptr[1]=='e' || inptr[1]=='E') && (inptr[2]=='g' || inptr[2]=='G') && isspace(inptr[3])) {
                inptr += 3;
						...
						if ((inptr[1] == 'e' || inptr[1] == 'E') && isspace(inptr[2])) {
							inptr += 2;
							tokenBuffer[tbndx] = tk_ne;
							tbndx++;
							return (token = tk_ne);
                ...
                inptr += 3;
						...
						if (gCpu == RISCV) {
							if ((inptr[1] == 'x' || inptr[1] == 'X') &&
								...
								isspace(inptr[6])) {
								inptr += 6;
								tokenBuffer[tbndx] = tk_nxtiof;
								tbndx++;
								return (token = tk_nxtiof);
							}
						}
						break;
                    ...
                    inptr += 5;
						...
						if (gCpu == RISCV) {
							...
							if ((inptr[1] == 'r' || inptr[1] == 'R') &&
								...
								isspace(inptr[6])) {
								inptr += 6;
								tokenBuffer[tbndx] = tk_prviof;
								tbndx++;
								return (token = tk_prviof);
							}
						}
						break;
        ...
        case 'r': case 'R':
					...
					if (gCpu == RISCV) {
						...
						if ((inptr[1] == 'm' || inptr[1] == 'M') &&
							...
							isspace(inptr[6])) {
							inptr += 6;
							tokenBuffer[tbndx] = tk_rmviof;
							tbndx++;
							return (token = tk_rmviof);
						}
					}
        ...
        case 's': case 'S':
			...
			if (gCpu==DSD9 || gCpu=='J' || gCpu==NVIO3 || gCpu==RISCV || gCpu==THOR2020) {
				if ((inptr[1]=='t' || inptr[1]=='T') &&
					(inptr[2]=='d' || inptr[2]=='D') &&
					isspace(inptr[3])) {
					inptr += 3;
        ...
        case 'w': case 'W':
					if (gCpu == THOR2020) {
						if ((inptr[1] == 't' || inptr[1] == 'T') &&
							...
							isspaceOrDot(inptr[4])) {
							inptr += 4;
							tokenBuffer[tbndx] = tk_wtop;
							tbndx++;
							return token = tk_wtop;
						}
						if ((inptr[1] == 'e' || inptr[1] == 'E') &&
							(inptr[2] == 'x' || inptr[2] == 'X') &&
							(inptr[3] == 'i' || inptr[3] == 'I') &&
							...
							isspaceOrDot(inptr[5])) {
							inptr += 6;
							tokenBuffer[tbndx] = tk_wexit;
							tbndx++;
							return token = tk_wexit;
						}
					}
             if ((inptr[1]=='a' || inptr[1]=='A') &&
                 (inptr[2]=='i' || inptr[2]=='I') &&
