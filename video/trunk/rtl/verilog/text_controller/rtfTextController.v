...
parameter pColorAddress = 32'hFFD10000;
...
// I/O range Dx
//--------------------------------------------------------------------
wire cs_text = cyc_i && stb_i && (adr_i[33:18]==pTextAddress[31:16]);
wire cs_color= cyc_i && stb_i && (adr_i[33:18]==pColorAddress[31:16]);
wire cs_rom  = cyc_i && stb_i && (adr_i[33:18]==pBitmapAddress[31:16]);
wire cs_reg  = cyc_i && stb_i && (adr_i[33:10]==pRegAddress[31:8]);
...
always @(scanindex or cursorType)
	...
	5'b11_000:	curout = 8'b11111111;
	5'b11_001:	curout = 8'b10000001;
	5'b11_010:	curout = 8'b10000001;
	5'b11_011:	curout = 8'b10000001;
	5'b11_100:	curout = 8'b10000001;
	5'b11_101:	curout = 8'b10000001;
	5'b11_110:	curout = 8'b10011001;
	5'b11_111:	curout = 8'b11111111;
	endcase
